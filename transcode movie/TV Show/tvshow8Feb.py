...
def downloadImage(series_title, season_title, episode_title, name, url, cipher_mode, key, iv):
    ...
    if series_title and not season_title and not episode_title:
        ...
        del response
        encrypt(out_file, out_file, cipher_mode, key, iv)
...
if __name__ == "__main__":    
    ...
    iv = getHash(series_title)
    # download images for series
    downloadImage(series_title, '', '', posterFileName, series_thumb, cipher_mode, key, iv), downloadImage(series_title, '', '', imageBaseName, series_art, cipher_mode, key, iv)     
    # dowmload images for season
    iv = getHash(series_title + '-' + season_title)
    downloadImage(series_title, season_title, '', posterFileName, season_thumb, cipher_mode, key, iv), downloadImage(series_title, season_title, '', imageBaseName, series_art, cipher_mode, key, iv)
    ...
    for item in returnData:
        ...
        iv = getHash(series_title + '-' + season_title + '-' + episode_title)
        downloadImage(series_title, season_title, episode_title, posterFileName, episode_thumb, cipher_mode, key, iv), downloadImage(series_title, season_title, episode_title, imageBaseName, episode_thumb, cipher_mode, key, iv)
